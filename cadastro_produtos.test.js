...
//Cenario de Insucesso - Não existe alteracao no produto!
test ('Atualizar o produto com Id 6 com informações faltantes deve gerar exceção de dados incompletos',
    function() {
        const produtoAtualizar = {
            preco: 100
        };
